...
// namespace fantasy
// {
// 	bool RayTracingTestPass::compile(DeviceInterface* device, RenderResourceCache* cache)
// 	{
// 		// Binding Layout.
// 		{
// 			BindingLayoutItemArray binding_layout_items(3);
// 			binding_layout_items[0] = BindingLayoutItem::create_push_constants(Slot, sizeof(constant));
// 			binding_layout_items[0] = BindingLayoutItem::create_constant_buffer(Slot);
...
// 	bool RayTracingTestPass::execute(CommandListInterface* cmdlist, RenderResourceCache* cache)
// 	{

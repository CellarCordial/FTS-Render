...
namespace fantasy
{
	...
	bool VirtualMesh::cluster_triangles()
	{
		SimpleGraph edge_link_graph;
	...
	bool VirtualMesh::build_cluster_groups(uint32_t level_offset, uint32_t level_cluster_count, uint32_t mip_level)
	{
	...
	bool VirtualMesh::build_parent_clusters(uint32_t cluster_group_index)
	{

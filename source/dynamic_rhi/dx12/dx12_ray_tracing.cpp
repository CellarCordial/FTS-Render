...
// 		DX12AccelStruct::DX12AccelStruct(const DX12Context* context, DX12DescriptorManager* descriptor_heaps, const AccelStructDesc& desc) :
// 			_context(context), 
...
// 			DX12Buffer* dx12_buffer = new DX12Buffer(_context, _descriptor_manager, desc);
